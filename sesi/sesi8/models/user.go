...
type User struct {
	...
	Pasword   string `gorm:"not null" json:"password" form:"password" valid:"required~Your password is required, minstringlength(6)~Password has to have a minimum length of 6 characters"`
...
func (u *User) BeforeCreate(tx *gorm.DB) (err error) {
	...
	u.Pasword = helpers.HashPass(u.Pasword)
